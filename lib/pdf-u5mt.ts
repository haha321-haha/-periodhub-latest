...
export const PDF_RESOURCES: PDFResource[] = [
  // 管理工具类 (4个)
  {
    ...
    titleKey: 'painTracking.title',
    descriptionKey: 'painTracking.description',
  ...
  },
  {
    ...
    titleKey: 'naturalTherapy.title',
    descriptionKey: 'naturalTherapy.description',
    category: 'management-tools',
    featured: false,
    fileSize: 1200,
    createdAt: '2024-12-19',
  ...
  },
  {
    ...
    titleKey: 'healthyHabits.title',
    descriptionKey: 'healthyHabits.description',
    category: 'management-tools',
    featured: false,
    fileSize: 702,
    createdAt: '2024-12-19',
  ...
  },
  {
    ...
    titleKey: 'specificManagement.title',
    descriptionKey: 'specificManagement.description',
    category: 'management-tools',
    featured: false,
    fileSize: 820,
    createdAt: '2024-12-19',
  ...
  // 健康管理类 (4个)
  {
    ...
    titleKey: 'nutritionPlan.title',
    descriptionKey: 'nutritionPlan.description',
  ...
  },
  {
    ...
    titleKey: 'magnesiumGuide.title',
    descriptionKey: 'magnesiumGuide.description',
    category: 'health-management',
    featured: false,
    fileSize: 1000,
    createdAt: '2024-12-19',
  ...
  },
  {
    ...
    titleKey: 'complicationsManagement.title',
    descriptionKey: 'complicationsManagement.description',
    category: 'health-management',
    featured: false,
    fileSize: 888,
    createdAt: '2024-12-19',
  ...
  },
  {
    ...
    titleKey: 'zhanZhuangGuide.title',
    descriptionKey: 'zhanZhuangGuide.description',
    category: 'health-management',
    featured: false,
    fileSize: 867,
    createdAt: '2024-12-19',
  ...
  // 沟通指导类 (4个)
  {
    ...
    titleKey: 'campusEmergency.title',
    descriptionKey: 'campusEmergency.description',
  ...
  },
  {
    ...
    titleKey: 'parentCommunication.title',
    descriptionKey: 'parentCommunication.description',
    category: 'communication-guidance',
    featured: false,
    fileSize: 642,
    createdAt: '2024-12-19',
  ...
  },
  {
    ...
    titleKey: 'teacherCollaboration.title',
    descriptionKey: 'teacherCollaboration.description',
    category: 'communication-guidance',
    featured: false,
    fileSize: 679,
    createdAt: '2024-12-19',
