...
export const constitutionQuestions: Record<string, ConstitutionQuestion[]> = {
  ...
  en: [
    ...
    // New menstrual pain related questions
    {
      ...
      description: 'Choose the description that best fits your menstrual pain experience',
      validation: { required: true },
      options: [
        {
          value: 'no_pain',
          label: 'Almost no pain, does not affect daily activities',
          weight: 3,
          constitutionType: 'balanced'
        },
        {
          value: 'mild_pain',
          label: 'Mild pain, tolerable',
          weight: 2,
          constitutionType: 'qi_deficiency'
        },
        {
          value: 'moderate_pain',
          label: 'Moderate pain, need rest or pain medication',
          weight: 3,
          constitutionType: 'blood_stasis'
        },
        {
          value: 'severe_pain',
          label: 'Severe pain, seriously affects daily activities',
          weight: 4,
          constitutionType: 'qi_stagnation'
        }
      ]
