  ...
  zh: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'very_irregular', label: t('tools.非常不规律'), weight: 3 }
      ]
    },
    {
      id: 'pain_severity',
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'unable_function', label: t('tools.无法正常活动需要卧床'), weight: 4 }
      ]
    },
    {
      ...
      options: [
        ...
        { value: 'depression', label: t('tools.情绪低落'), icon: '😢', weight: 2 }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'very_poor', label: t('tools.很差严重失眠'), weight: 3 }
      ]
    },
    {
