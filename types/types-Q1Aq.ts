...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  try {
    ...
    const [
      ...
      import(`../public/locales/${locale}/interactiveTools.json`).then(m => m.default).catch(() => ({})),
      import(`../public/locales/${locale}/toolPage.json`).then(m => m.default).catch(() => ({}))
    ]);
    ...
    if (locale !== defaultLocale) {
      try {
        const [
          ...
          import(`../public/locales/${defaultLocale}/interactiveTools.json`).then(m => m.default).catch(() => ({}))
        ]);
        ...
        const fallbackMessages = {
          ...
          interactiveTools: fallbackInteractiveTools
        };
