...
export function getArticleBySlug(slug: string, locale: string = 'en'): Article | null {
  try {
    ...
    return {
      slug,
      title: data.title || '',
      title_zh: data.title_zh || data.title_en,
      date: data.date || '',
      summary: data.summary || '',
      summary_zh: data.summary_zh || data.summary_en,
      tags: data.tags || [],
      tags_zh: data.tags_zh || data.tags_en,
      category: data.category || '',
      category_zh: data.category_zh || data.category_en,
      author: data.author || '',
      featured_image: data.featured_image || '',
      reading_time: data.reading_time || '',
      reading_time_zh: data.reading_time_zh || data.reading_time_en,
      content,
      seo_title: data.seo_title,
      seo_title_zh: data.seo_title_zh || data.seo_title_en,
      seo_description: data.seo_description,
      seo_description_zh: data.seo_description_zh || data.seo_description_en,
